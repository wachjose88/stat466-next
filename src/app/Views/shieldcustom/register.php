        ...
        <div class="card col-12 col-md-5 shadow-sm">
            <div class="card-body">
                ...
                <form action="<?= url_to('register') ?>" method="post">
                    ...
                    <!-- First name -->
                    <div class="mb-2">
                        <input type="text" class="form-control" name="first_name" inputmode="text" autocomplete="first_name" placeholder="<?= lang('stat466.Auth.first_name') ?>" value="<?= old('first_name') ?>" required />
                    </div>

                    <!-- Last name -->
                    <div class="mb-5">
                        <input type="text" class="form-control" name="last_name" inputmode="text" autocomplete="last_name" placeholder="<?= lang('stat466.Auth.last_name') ?>" value="<?= old('last_name') ?>" required />
                    </div>
